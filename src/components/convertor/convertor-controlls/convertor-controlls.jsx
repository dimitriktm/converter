    ...
    render() {
        ...
        return (
            <Grid columns='equal'>
                <Grid.Row>
                    <Grid.Column>
                        <Dropdown onChange={onMeasuramentSelect} className='label purple' fluid
                                  scrolling value={measurament} options={this.getDropdownMeasuresList()}/>
                    </Grid.Column>
                </Grid.Row>
                <Grid.Row>
                    <Grid.Column>
                        <Input
                            label=
                                {
                                    <Dropdown onChange={onUnitChange}
                                              className='purple'
                                              value={selectedUnit}
                                              options={unitsList}/>
                                }
                    ...
                    <Grid.Column>
                        <Button onClick={onConvert} size='small'
                                className='purple'>Convert</Button>
                    </Grid.Column>
                </Grid.Row>
            </Grid>
        )
